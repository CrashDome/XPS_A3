...
class XPS_DT_BTDebugConsole_display {
	...
	class Controls 
	{
		class XPS_DT_BTDebugConsole_frame: XPS_DT_RscText
		{
			...
			w = XPS_STR(20.4 * GUI_GRID_CENTER_W);
			h = XPS_STR(25.2 * GUI_GRID_CENTER_H);
		...
		class XPS_DT_BTDebugConsole_bkgrd: XPS_DT_RscText
		{
			...
			w = XPS_STR(20 * GUI_GRID_CENTER_W);
			h = XPS_STR(24 * GUI_GRID_CENTER_H);
		};
		class XPS_DT_BTDebugConsole_TVbkgrd: XPS_DT_RscText
		{
			...
			w = XPS_STR(16 * GUI_GRID_CENTER_W);
			h = XPS_STR(23 * GUI_GRID_CENTER_H);
			colorBackground[] = {0,0,0,1};
		};
		...
		{
			idc = 1604;
			x = XPS_STR(17 * GUI_GRID_CENTER_W + GUI_GRID_CENTER_X);
			y = XPS_STR(21 * GUI_GRID_CENTER_H + GUI_GRID_CENTER_Y);
			w = XPS_STR(2.5 * GUI_GRID_CENTER_W);
			h = XPS_STR(2 * GUI_GRID_CENTER_H);
			text = "Close";
